...
public class App {
    ...
    private static void createMockApplicants() {
        // Create applicants
        Applicant applicant1 = new Applicant("S1234567A", "John Applicant", "password", 32, User.MaritalStatus.MARRIED);
    ...
    private static void createMockOfficers() {
        // Create officers
        HDBOfficer officer1 = new HDBOfficer("S1234567O", "Alice Officer", "password", 30, User.MaritalStatus.MARRIED);
